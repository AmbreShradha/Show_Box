<?php $__env->startSection('content'); ?>
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="<?php echo e($movie['poster_path']); ?>" alt="poster" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-movies-example-master\resources\views/movies/show.blade.php ENDPATH**/ ?>